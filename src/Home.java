...
DefaultTableModel dtm;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(str.equalsIgnoreCase("Vaccination"))
        {
            ...
            Apply a=new Apply(str1,str2,str3,str4,str5,"vaccination");
            session.save(a);
        }
         if(str.equalsIgnoreCase("Ward in Hospital"))
        {
            Apply a=new Apply(str1,str2,str3,"",str5,"hospital");
            session.save(a);
        }
         
                  if(str.equalsIgnoreCase("Volunteering"))
        {
            Apply a=new Apply(str1,str2,str3,str4,str5,"volunteer");
            session.save(a);
        }
                  tx.commit();
                  cl.show(jPanel1, "home");
