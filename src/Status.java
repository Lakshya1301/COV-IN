    ...
    public void run()
{
            ...
            {
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/welcome (1).wav").toURI().toURL());
                        play.start();
                        i=1;
          ...
          jLabel7.setVisible(true);
                ...
                jButton2.setText("no");
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q1.wav").toURI().toURL());
                        play.start();
                    ...
                    if(i==2)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q2.wav").toURI().toURL());
                        play.start();
          ...
          if(i==3)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q3.wav").toURI().toURL());
                        play.start();
           ...
           if(i==4)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q4.wav").toURI().toURL());
                        play.start();
            ...
            if(i==5)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q5.wav").toURI().toURL());
                        play.start();
             ...
             if(i==6)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q6.wav").toURI().toURL());
                        play.start();
              ...
              if(i==7)
            {
                ...
                jLabel6.setVisible(false);
                    ...
                    try {
                        Player play=Manager.createRealizedPlayer(new File("D:/Projects/COV-IN/src/q7.wav").toURI().toURL());
                        play.start();
